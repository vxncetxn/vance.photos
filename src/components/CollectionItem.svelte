...
<a on:mouseenter={handleMouseEnter} href={`/${collection.slug}`} class="mt-10 text-6xl text-transparent cursor-pointer text-stroke hover:text-white">{collection.name}</a>